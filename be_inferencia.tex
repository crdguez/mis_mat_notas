...
\begin{block}{Error máximo cometido:} $$E=z_{\alpha / 2}\cdot \frac{\sigma}{\sqrt{n}}$$
...
$$ \left( \overline{p} - z_{\alpha / 2}\cdot \sqrt{\frac{\overline{p}\cdot\left(1-\overline{p} \right)}{n}} ,  \overline{p} + z_{\alpha / 2}\cdot \sqrt{\frac{\overline{p}\cdot\left(1-\overline{p} \right)}{n}}\right)$$
siendo: \begin{itemize}
\item $\overline{p}$: La proporción muestral
...
\begin{column}{0.55\textwidth}
    \textbf{Datos:} $\overline{p}=0.21$, Confianza=$96$ \\
