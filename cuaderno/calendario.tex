...
\documentclass[a4paper, spanish, 9pt]{scrartcl}
%\documentclass[a4paper, spanish, 9pt]{article}
...
\setlength{\headheight}{3.ex}
\chead{
  \fontsize{40}{10}\selectfont\textbf{\year/\nyear}
...
\calendar[
  ...
  day code=
  {
    ...
    minimum height= .8cm, text width = 6.5cm, draw = gray]{ \footnotesize{\tikzdaytext}};
    \draw (-3.cm, -.0ex) node[anchor = west]{\footnotesize%
  ...
  execute before day scope=
  {
    ...
    {
      % Shift right
      \pgftransformxshift{6.8cm}
      % Print month name 
      \draw (0,0)node [shape=rectangle, minimum height= .56cm,
        text width = 6.5cm, fill = red, text= white, draw = red, text centered]
