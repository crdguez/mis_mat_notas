...
\begin{figure}[h]
   \centering
   \includegraphics[page=1,width=.45\textwidth]{probabilidad/distribucionnormal.pdf}
%   \begin{tabular}{@{}c@{\hspace{.5cm}}c@{}}
%       \includegraphics[page=1,width=.45\textwidth]{probabilidad/distribucionnormal} %& 
...
%\includepdf[pages=-,scale=0.9]{probabilidad/distribucionnormal.pdf}
